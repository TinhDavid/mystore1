...
class __TwigTemplate_38ae98a29c34bfb83556d4313130d28d extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"layout-store-form layout-commerce-form\">
  <div class=\"layout-region layout-region--commerce-main\">
    <div class=\"layout-region__content\">
      ";
        // line 16
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->withoutFilter($this->sandbox->ensureToStringAllowed(($context["form"] ?? null), 16, $this->source), "advanced", "actions"), "html", null, true);
        echo "
    </div>
  </div>
...
";
    ...
    {
        return array (  59 => 23,  53 => 20,  46 => 16,  39 => 12,);
    }
