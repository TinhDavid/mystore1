...
class __TwigTemplate_d87d557be9cae8c58f95d406db16c483 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"layout-product-form layout-commerce-form\">
  <div class=\"layout-region layout-region--commerce-main\">
    <div class=\"layout-region__content\">
      ";
        // line 16
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->withoutFilter($this->sandbox->ensureToStringAllowed(($context["form"] ?? null), 16, $this->source), "advanced", "footer", "actions"), "html", null, true);
        echo "
    </div>
  </div>
  ...
  <div class=\"layout-region layout-region--commerce-footer\">
    ";
        // line 23
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "footer", [], "any", false, false, true, 23), 23, $this->source), "html", null, true);
        echo "
    ";
        // line 24
